...
export function Footer() {
  const links = [
    ...
    { icon: Instagram, href: 'https://instagram.com/tedxteddy', label: 'tedxteddy' },
    { icon: Instagram, href: 'https://instagram.com/designbytedx', label: 'designbytedx' },
      ...
      <div className="flex items-center gap-2 md:gap-4 overflow-x-auto">
        {links.map((link, i) => (
          <a
            ...
            className="flex items-center gap-1.5 text-hw-text-dim hover:text-hw-primary transition-colors group flex-shrink-0"
          >
